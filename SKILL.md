...
Use this skill when the user explicitly asks to use **视觉工作室**, **VS**, **visual-studio**, **opus**, or **gpt-image-2 直连** for image generation.
...
Set `--size` only when the user requested a concrete supported size.
